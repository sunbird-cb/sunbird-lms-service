...
public class OTPService {
   ...
   */
  public Map<String, Object> getOTPDetailsV3(String type, String key, String contextType, String contextAttributes, RequestContext requestContext) {
    // Delegate the retrieval operation to the OTP DAO.
    return otpDao.getOTPDetailsV3(type, key, contextType, contextAttributes, requestContext);
  }
